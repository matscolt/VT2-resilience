...
# - INTERNAL  -
# make a random starting guess for the schedule and process plan selection

# takes the production plan and creates a schedule for the production line as an iteration by using algo.py
# the schedule is then used to run a simulation without disruptions to evaluate the schedule 
...
# -  OUTPUT  -
# a sorted schedule (running 5 days ahead) for the production sim to run 
