...
def run_tabu_search(
    ...
    current_solution = create_order_seed(
        orders
    )
    ...
    print("\n================================================")
    print("EVALUATING INITIAL TABU SOLUTION")
    print("================================================")
    ...
    for iteration in range(1, TABU_ITERATIONS + 1):
        ...
        for neighbor_index in range(1, NEIGHBORHOOD_SIZE + 1):
            ...
            # A tabu move is allowed if it gives a new global best.
        ...
        if best_candidate_solution is None:
            ...
            print("Choosing the least bad tabu candidate is not implemented.")
            print("Stopping Tabu Search.")
            break
...
def main():
    print("\n================================================")
    print("STARTING TABU SEARCH SCHEDULER")
    print("================================================")
    ...
    export_schedule(
        ...
        order_units=order_units,
        units_lookup=units_lookup,
        filename="best_schedule_tabu.csv",
        verbose=True
    )
